...
1. Obtain vectors (e.g. plasmids)

[Extract plasmid with antibiotic resistance gene from bacterium]

1. Cut DNA fragments and plasmids using restriction enzyme (Restriction)
...
1. Join DNA fragment/plasmid together using DNA ligase (Ligation)
...
- Example: Production of human insulin using recombinant plasmids
    - *coli* commonly used as host cell.
- Mix  *coli* with recombinant plasmids
    - Some  *coli* receive recombinant plasmid (transformed bacterium)
...
- Using recombinant DNA technology
    - Obtain toxin gene from toxin-producing bacterium and plasmid from *Agrobacterium*
    - Cut with same restriction enzyme
    - Ligation of DNA fragment and plasmid
    - Introduce plasmid into *Agrobacterium*
    - Infect maize cell
    - Cell develops into adult plant
...
- Benefits/Hazards
    - Benefits
        - Large amounts of useful products can be produced in a shorter time at lower cost
            - g. Production of human insulin (refer to above)
        - Food supplies increased with GMOs of higher productivity
            - g. fast-growing GM salmon increases supply of salmon
        - Higher nutritional value foods
            - g. Golden Rice is rich in β-carotene, which can be converted to vitamin A in human body
...
- Restriction fragment length polymorphism (RFLP) analysis [Gel electrophoresis]
    - Add restriction enzymes to DNA samples and incubated
        - DNA fragments produced with some having VNTRs
    - Place fragments (bands) on the end of gel slab connected to negative electrode
